# Create ready-to-upload files for your GitHub Pages site.
# We'll save:
...
document.getElementById('gotItBtn').onclick=()=>{let s=loadStats();s.correct=(s.correct||0)+1;saveStats(s);alert("Marked as known ✅");}
document.getElementById('notYetBtn').onclick=()=>{let s=loadStats();s.incorrect=(s.incorrect||0)+1;saveStats(s);alert("Keep practicing ❌");}
